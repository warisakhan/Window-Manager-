...
//setters getters contains and booleans 
...
public class Window {
	 ...
	 * @param selected is the variable for selected. 
	 */
	 ...
	 * @return boolean is the selected true or false.
	 */
	...
	/**
	 * contains method that checks if x and y are inside the bounds. 
	 * @param x is the x coordinate being passed in. 
	 * @param y is the y coordinate being passed in. 
	 * @return boolean which is true if the x and y coordinates are in the bounds. 
	 */
	public boolean contains (int x, int y) {

		if (x >= this.upperLeftX && x <= this.upperLeftX + this.width && y >= this.upperLeftY && y <= this.upperLeftY + this.height){
			return true;
		}
		...
		//if neither is found, returns false 
